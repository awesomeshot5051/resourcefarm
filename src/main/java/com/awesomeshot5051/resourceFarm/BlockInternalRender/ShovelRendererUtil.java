...
public class ShovelRendererUtil {
    ...
    public static <T extends FarmTileentity> void renderSwingingShovel(T farm, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay, ItemStack pickaxeStack, Direction direction, long timer) {
        Farm = farm;
        ...
        float angle = (float) Math.sin(swingProgress * Math.PI * 2) * 30;
