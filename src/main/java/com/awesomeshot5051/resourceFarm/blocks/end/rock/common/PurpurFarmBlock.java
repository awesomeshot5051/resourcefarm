...
public class PurpurFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    private void playSound(@NotNull Level level, BlockState state, SoundEvent sound, PurpurFarmTileentity farm) {
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof PurpurFarmTileentity farmTileEntity) {
