...
public class NetherQuartzOreFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    private void playSound(@NotNull Level level, BlockState state, SoundEvent sound, NetherQuartzOreFarmTileentity farm) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        NetherQuartzOreFarmTileentity trader = BlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new NetherQuartzOreFarmTileentity(BlockPos.ZERO, ModBlocks.NETHER_QUARTZ_FARM.get().defaultBlockState()));
    }
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new NetherQuartzOreFarmTileentity(blockPos, blockState);
    }
