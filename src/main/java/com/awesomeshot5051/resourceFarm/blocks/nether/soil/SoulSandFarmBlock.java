package com.awesomeshot5051.resourceFarm.blocks.nether.soil;
...
import com.awesomeshot5051.resourceFarm.items.render.nether.soil.*;
...
public class SoulSandFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new SoulSandFarmItemRenderer();
            }
        };
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        SoulSandFarmTileentity trader = VillagerBlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new SoulSandFarmTileentity(BlockPos.ZERO, ModBlocks.SSAND_FARM.get().defaultBlockState()));
        SoulSandFarmTileentity trader2 = FarmBlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new SoulSandFarmTileentity(BlockPos.ZERO, ModBlocks.SSAND_FARM.get().defaultBlockState()));
    }
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof SoulSandFarmTileentity farmTileEntity) {
            ...
            if (pickType != null) {
                farmTileEntity.shovelType = pickType.getStackInSlot(0);
    ...
    private void playSound(@NotNull Level level, BlockState state, SoundEvent sound, SoulSandFarmTileentity farm) {
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof SoulSandFarmTileentity farm)) {
            return super.useItemOn(heldItem, state, worldIn, pos, player, handIn, hit);
        }
        playSound(Objects.requireNonNull(worldIn), state, ModSounds.SHOVEL_SOUND.get(), farm);
        player.openMenu(new MenuProvider() {
            ...
            public AbstractContainerMenu createMenu(int id, Inventory playerInventory, Player player) {
                return new OutputContainer(id, playerInventory, farm.getOutputInventory(), ContainerLevelAccess.create(worldIn, pos), ModBlocks.SSAND_FARM::get);
            }
        });
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new SoulSandFarmTileentity(blockPos, blockState); // Spawn EndermanFarmTileentity
    }
