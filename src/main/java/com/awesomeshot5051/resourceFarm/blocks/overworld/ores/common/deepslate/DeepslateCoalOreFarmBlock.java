...
public class DeepslateCoalOreFarmBlock extends BlockBase implements EntityBlock {

    public static final EnumProperty<PickaxeType> PICKAXE_TYPE = EnumProperty.create("pickaxe_type", PickaxeType.class);

    public DeepslateCoalOreFarmBlock(Properties properties) {
        super(properties.mapColor(MapColor.STONE).strength(2.5F).sound(SoundType.STONE).noOcclusion()); // Adjusted for enderman farm
    ...
    /*
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new DeepslateCoalOreFarm*/
