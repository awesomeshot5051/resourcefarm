...
public class EmeraldOreFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        EmeraldOreFarmTileentity trader = BlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new EmeraldOreFarmTileentity(BlockPos.ZERO, ModBlocks.EMERALD_FARM.get().defaultBlockState()));
    }
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new EmeraldOreFarmTileentity(blockPos, blockState);
    }
