...
public class DirtFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        DirtFarmTileentity trader = BlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new DirtFarmTileentity(BlockPos.ZERO, ModBlocks.DIRT_FARM.get().defaultBlockState()));
    }
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new DirtFarmTileentity(blockPos, blockState);
    }
