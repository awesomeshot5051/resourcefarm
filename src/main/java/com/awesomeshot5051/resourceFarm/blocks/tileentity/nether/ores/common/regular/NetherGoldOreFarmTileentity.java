...
public class NetherGoldOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public NetherGoldOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.NETHER_GOLD_FARM.get(), ModBlocks.NETHER_GOLD_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getNetherGoldGenerateTime(NetherGoldOreFarmTileentity tileEntity) {
    ...
    public static double getNetherGoldBreakTime(NetherGoldOreFarmTileentity tileEntity) {

        return getNetherGoldGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    public void tick() {
        timer++;
        if (timer >= getNetherGoldBreakTime(this)) {
