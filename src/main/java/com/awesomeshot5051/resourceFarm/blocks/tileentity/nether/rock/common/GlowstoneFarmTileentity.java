...
public class GlowstoneFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getGlowstoneBreakTime(GlowstoneFarmTileentity tileEntity) {
        ...
        return getGlowstoneGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.GLOWSTONE)); // Change this as needed for custom loot
        return drops;
    }
