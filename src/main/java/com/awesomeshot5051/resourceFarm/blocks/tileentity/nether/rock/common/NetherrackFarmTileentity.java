...
public class NetherrackFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getNetherrackBreakTime(NetherrackFarmTileentity tileEntity) {
        ...
        return getNetherrackGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.NETHERRACK)); // Change this as needed for custom loot
        return drops;
    }
