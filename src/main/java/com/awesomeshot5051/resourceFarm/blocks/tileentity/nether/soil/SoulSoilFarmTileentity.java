...
public class SoulSoilFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public SoulSoilFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.SSOIL_FARM.get(), ModBlocks.SSOIL_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getSoulSoilGenerateTime(SoulSoilFarmTileentity tileEntity) {
    ...
    public static double getSoulSoilBreakTime(SoulSoilFarmTileentity tileEntity) {
        ...
        return getSoulSoilGenerateTime(tileEntity) + (shovel.equals(ShovelType.NETHERITE) ? (baseValue * 8) :
    ...
    public void tick() {
        ...
        if (timer >= getSoulSoilBreakTime(this)) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.SOUL_SOIL, dropCount));
        return drops;
    }
    ...
    protected void saveAdditional(CompoundTag compound, HolderLookup.Provider provider) {
        ...
        if (shovelType != null) {
            ...
            compound.put("ShovelType", pickTypeTag);
        }
