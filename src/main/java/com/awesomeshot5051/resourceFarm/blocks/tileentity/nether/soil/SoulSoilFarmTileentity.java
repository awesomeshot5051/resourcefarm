...
public class SoulSoilFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getSoulSoilBreakTime(SoulSoilFarmTileentity tileEntity) {
        return getSoulSoilGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_SHOVEL) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.SOUL_SOIL)); // Change this as needed for custom loot
        return drops;
    }
