...
public class DeepslateCopperOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
...
//    private static final ResourceKey<LootTable> ENDERMAN_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/enderman"));
    ...
    public DeepslateCopperOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DCOPPER_FARM.get(), ModBlocks.DCOPPER_FARM.get().defaultBlockState(), pos, state);
