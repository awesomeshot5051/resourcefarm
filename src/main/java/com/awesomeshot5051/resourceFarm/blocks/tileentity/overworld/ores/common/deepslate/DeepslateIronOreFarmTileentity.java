...
public class DeepslateIronOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public DeepslateIronOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DIRON_FARM.get(), ModBlocks.DIRON_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getIronGenerateTime(DeepslateIronOreFarmTileentity tileEntity) {
    ...
    public static double getIronBreakTime(DeepslateIronOreFarmTileentity tileEntity) {
...
//
    ...
    private List<ItemStack> getDrops() {
        ...
        if (getPickaxeEnchantmentStatus(pickaxeEnchantments, Enchantments.SILK_TOUCH)) {
            ...
            } else drops.add(new ItemStack(Items.DEEPSLATE_IRON_ORE));
        } else if (upgradeEnabled) {
            drops.add(new ItemStack(Items.IRON_INGOT));
        } else drops.add(new ItemStack(Items.RAW_IRON, dropCount));
        return drops;
    }
