...
public class GoldOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getGoldGenerateTime(GoldOreFarmTileentity tileEntity) {
        return (double) Main.SERVER_CONFIG.goldGenerateTime.get() /
    ...
    public static double getGoldBreakTime(GoldOreFarmTileentity tileEntity) {
