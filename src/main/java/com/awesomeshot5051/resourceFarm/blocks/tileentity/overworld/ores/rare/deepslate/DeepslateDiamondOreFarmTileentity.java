package com.awesomeshot5051.resourceFarm.blocks.tileentity.overworld.ores.rare.deepslate;
...
public class DeepslateDiamondOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public DeepslateDiamondOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DDIAMOND_FARM.get(), ModBlocks.DDIAMOND_FARM.get().defaultBlockState(), pos, state);
...
//
    ...
    private List<ItemStack> getDrops() {
        ...
        if (getPickaxeEnchantmentStatus(pickaxeEnchantments, Enchantments.SILK_TOUCH)) {
            drops.clear();
            drops.add(new ItemStack(Items.DEEPSLATE_DIAMOND_ORE));
        }
        return drops;
    }
