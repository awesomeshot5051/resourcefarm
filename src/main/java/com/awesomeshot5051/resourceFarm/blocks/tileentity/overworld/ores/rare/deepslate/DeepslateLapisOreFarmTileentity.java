...
public class DeepslateLapisOreFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public DeepslateLapisOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DLAPIS_FARM.get(), ModBlocks.DLAPIS_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getLapisBreakTime(DeepslateLapisOreFarmTileentity tileEntity) {
