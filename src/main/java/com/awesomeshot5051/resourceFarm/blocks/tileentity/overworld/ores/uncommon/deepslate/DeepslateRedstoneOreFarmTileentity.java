...
public class DeepslateRedstoneOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getRedstoneBreakTime(DeepslateRedstoneOreFarmTileentity tileEntity) {
        ...
        return getRedstoneGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.IRON_PICKAXE) ? (20 * 4) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.REDSTONE, count)); // Change this as needed for custom loot
        return drops;
    }
