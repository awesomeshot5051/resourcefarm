package com.awesomeshot5051.resourceFarm.blocks.tileentity.overworld.ores.uncommon.regular;
...
public class RedstoneOreFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public RedstoneOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.REDSTONE_FARM.get(), ModBlocks.REDSTONE_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getRedstoneBreakTime(RedstoneOreFarmTileentity tileEntity) {
    ...
    private List<ItemStack> getDrops() {
        ...
        if (getPickaxeEnchantmentStatus(pickaxeEnchantments, Enchantments.SILK_TOUCH)) {
            ...
            else drops.add(new ItemStack(Items.REDSTONE_ORE, 1));
        }
        return drops;
    }
