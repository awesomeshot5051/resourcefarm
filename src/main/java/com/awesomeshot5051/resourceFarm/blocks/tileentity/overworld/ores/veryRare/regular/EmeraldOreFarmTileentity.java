package com.awesomeshot5051.resourceFarm.blocks.tileentity.overworld.ores.veryRare.regular;
...
public class EmeraldOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public EmeraldOreFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.EMERALD_FARM.get(), ModBlocks.EMERALD_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getEmeraldGenerateTime(EmeraldOreFarmTileentity tileEntity) {
    ...
    public static double getEmeraldBreakTime(EmeraldOreFarmTileentity tileEntity) {

        return getEmeraldGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.IRON_PICKAXE) ? (20 * 4) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.EMERALD)); // Change this as needed for custom loot
        return drops;
    }
