...
public class EmeraldOreFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public EmeraldOreFarmTileentity(BlockPos pos, BlockState state) {
        ...
        pickType = new ItemStack(Items.IRON_PICKAXE);
    }
...
//
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.EMERALD, dropCount)); // Change this as needed for custom loot
        if (getPickaxeEnchantmentStatus(pickaxeEnchantments, Enchantments.SILK_TOUCH)) {
            drops.clear();
            drops.add(new ItemStack(Items.EMERALD_ORE, 1));
        }
        return drops;
    }
