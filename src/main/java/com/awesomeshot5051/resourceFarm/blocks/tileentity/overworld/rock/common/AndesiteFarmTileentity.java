...
public class AndesiteFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getAndesiteBreakTime(AndesiteFarmTileentity tileEntity) {
        ...
        return getAndesiteGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.ANDESITE)); // Change this as needed for custom loot
        return drops;
    }
