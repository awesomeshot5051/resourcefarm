...
public class CobblestoneFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public CobblestoneFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.COBBLESTONE_FARM.get(), ModBlocks.COBBLESTONE_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getStoneGenerateTime(CobblestoneFarmTileentity tileEntity) {
        return (double) Main.SERVER_CONFIG.coalGenerateTime.get() /
                (tileEntity.getPickType().getItem().equals(Items.WOODEN_PICKAXE) ? 5 :
    ...
    public static double getStoneBreakTime(CobblestoneFarmTileentity tileEntity) {

        return getStoneGenerateTime(tileEntity) +
                (tileEntity.getPickType().getItem().equals(Items.WOODEN_PICKAXE) ? (20 * 10) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.COBBLESTONE)); // Change this as needed for custom loot
        return drops;
    }
