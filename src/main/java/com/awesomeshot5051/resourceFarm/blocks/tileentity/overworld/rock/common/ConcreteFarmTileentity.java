...
public class ConcreteFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getConcreteBreakTime(ConcreteFarmTileentity tileEntity) {
        return getConcreteGenerateTime(tileEntity) + (tileEntity.pickType.getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
                        ...
                        tileEntity.getPickType().getItem().equals(Items.DIAMOND_PICKAXE) ? (20 * 2) :
                                tileEntity.getPickType().getItem().equals(Items.NETHERITE_PICKAXE) ? (20 * 2) :
                                        tileEntity.getPickType().getItem().equals(Items.GOLDEN_PICKAXE) ? (20 * 2) :
                                                (20 * 5)); // Default to Wooden PICKAXE break time if none matches
    }
