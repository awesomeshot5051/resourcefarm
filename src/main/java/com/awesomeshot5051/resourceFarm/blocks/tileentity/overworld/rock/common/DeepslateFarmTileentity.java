...
public class DeepslateFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getDeepslateBreakTime(DeepslateFarmTileentity tileEntity) {
        ...
        return getDeepslateGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.DEEPSLATE)); // Change this as needed for custom loot
        return drops;
    }
