...
public class DioriteFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public DioriteFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DIORITE_FARM.get(), ModBlocks.DIORITE_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getDioriteGenerateTime(DioriteFarmTileentity tileEntity) {
    ...
    public static double getDioriteBreakTime(DioriteFarmTileentity tileEntity) {
        ...
        return getDioriteGenerateTime(tileEntity) + (pickAxe.equals(PickaxeType.NETHERITE) ? (baseValue * 8) :
    ...
    public void tick() {
        ...
        if (timer >= getDioriteBreakTime(this)) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.DIORITE, dropCount));
        return drops;
    }
