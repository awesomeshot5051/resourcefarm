...
//
        return getGraniteGenerateTime(tileEntity) + (pickAxe.equals(PickaxeType.NETHERITE) ? (baseValue * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.GRANITE, dropCount)); // Change this as needed for custom loot
        return drops;
    }
