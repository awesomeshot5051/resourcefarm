...
public class ObsidianFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getObsidianBreakTime(ObsidianFarmTileentity tileEntity) {
        ...
        return getObsidianGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.OBSIDIAN)); // Change this as needed for custom loot
        return drops;
    }
