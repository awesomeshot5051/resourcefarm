...
public class ObsidianFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public ObsidianFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.OBSIDIAN_FARM.get(), ModBlocks.OBSIDIAN_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getObsidianGenerateTime(ObsidianFarmTileentity tileEntity) {
    ...
    public static double getObsidianBreakTime(ObsidianFarmTileentity tileEntity) {
        ...
        return getObsidianGenerateTime(tileEntity) + (pickAxe.equals(PickaxeType.NETHERITE) ? (baseValue * 8) :
    ...
    public void tick() {
        timer++;
        if (timer >= getObsidianBreakTime(this)) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.OBSIDIAN, dropCount));
        return drops;
    }
