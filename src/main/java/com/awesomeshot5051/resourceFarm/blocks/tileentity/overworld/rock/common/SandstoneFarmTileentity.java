...
//
        return getSstoneGenerateTime(tileEntity) + (pickAxe.equals(PickaxeType.NETHERITE) ? (baseValue * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.SANDSTONE, dropCount)); // Change this as needed for custom loot
        return drops;
    }
