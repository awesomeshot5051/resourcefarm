...
public class SandstoneFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public SandstoneFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.SSTONE_FARM.get(), ModBlocks.SSTONE_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getSstoneGenerateTime(SandstoneFarmTileentity tileEntity) {
    ...
    public static double getSstoneBreakTime(SandstoneFarmTileentity tileEntity) {

        return getSstoneGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_PICKAXE) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.SANDSTONE)); // Change this as needed for custom loot
        return drops;
    }
