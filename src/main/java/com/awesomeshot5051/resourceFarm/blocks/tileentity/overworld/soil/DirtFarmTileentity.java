...
public class DirtFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getDirtBreakTime(DirtFarmTileentity tileEntity) {
        return getDirtGenerateTime(tileEntity) + (tileEntity.getPickType().getItem().equals(Items.STONE_SHOVEL) ? (20 * 8) :
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.DIRT)); // Change this as needed for custom loot
        return drops;
    }
