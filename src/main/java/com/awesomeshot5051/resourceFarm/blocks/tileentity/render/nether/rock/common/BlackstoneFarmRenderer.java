...
public class BlackstoneFarmRenderer extends RendererBase<BlackstoneFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public BlackstoneFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(BlackstoneFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= BlackstoneFarmTileentity.getBlackstoneGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= BlackstoneFarmTileentity.getBlackstoneBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
