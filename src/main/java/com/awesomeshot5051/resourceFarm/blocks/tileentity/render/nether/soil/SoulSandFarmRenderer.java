...
public class SoulSandFarmRenderer extends RendererBase<SoulSandFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public SoulSandFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(SoulSandFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
