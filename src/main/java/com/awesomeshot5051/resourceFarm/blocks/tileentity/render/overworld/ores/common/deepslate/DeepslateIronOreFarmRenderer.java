...
public class DeepslateIronOreFarmRenderer extends RendererBase<DeepslateIronOreFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public DeepslateIronOreFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(DeepslateIronOreFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= DeepslateIronOreFarmTileentity.getIronGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= DeepslateIronOreFarmTileentity.getIronBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
