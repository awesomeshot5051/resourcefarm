...
public class DioriteFarmRenderer extends RendererBase<DioriteFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public DioriteFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(DioriteFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= DioriteFarmTileentity.getDioriteGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= DioriteFarmTileentity.getDioriteBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
