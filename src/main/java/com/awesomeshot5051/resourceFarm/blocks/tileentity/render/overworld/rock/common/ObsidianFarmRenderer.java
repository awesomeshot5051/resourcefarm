...
public class ObsidianFarmRenderer extends RendererBase<ObsidianFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public ObsidianFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(ObsidianFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= ObsidianFarmTileentity.getObsidianGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= ObsidianFarmTileentity.getObsidianBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
