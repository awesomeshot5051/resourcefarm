...
public class SandstoneFarmRenderer extends RendererBase<SandstoneFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public SandstoneFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(SandstoneFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= SandstoneFarmTileentity.getSstoneGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= SandstoneFarmTileentity.getSstoneBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
