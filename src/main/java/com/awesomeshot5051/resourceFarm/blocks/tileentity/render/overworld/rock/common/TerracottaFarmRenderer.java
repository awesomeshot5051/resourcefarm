...
public class TerracottaFarmRenderer extends RendererBase<TerracottaFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public TerracottaFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(TerracottaFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        } else if (farm.getTimer() >= TerracottaFarmTileentity.getTerracottaBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
