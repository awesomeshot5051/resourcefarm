...
public class MudFarmRenderer extends RendererBase<MudFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public MudFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(MudFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= MudFarmTileentity.getMudGenerateTime(farm)) {
