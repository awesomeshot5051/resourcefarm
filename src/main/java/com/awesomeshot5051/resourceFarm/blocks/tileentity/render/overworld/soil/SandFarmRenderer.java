...
public class SandFarmRenderer extends RendererBase<SandFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public SandFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(SandFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
