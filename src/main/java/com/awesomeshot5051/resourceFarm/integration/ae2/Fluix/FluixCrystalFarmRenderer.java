...
public class FluixCrystalFarmRenderer extends RendererBase<FluixCrystalFarmTileentity> {
    ...
    public void render(FluixCrystalFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        FluidStack fluidStack = farm.getFluid();
        ...
        renderFluid(farm, fluidStack, matrixStack, buffer, combinedLight, combinedOverlay);
//        if ((!farm.getAE2ItemsList().isEmpty()) && AE2Check.containsAllItems(farm.getAE2ItemsList(), AE2Blocks.itemsRequiredForFC)) {
...
//        float capacity = (float) blockEntity.getCapacity();
        float capacity = 100f;
