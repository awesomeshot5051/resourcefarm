...
public class MysteriousCubeFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public MysteriousCubeFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.MC_FARM.get(), ModBlocks.MC_FARM.get().defaultBlockState(), pos, state);
