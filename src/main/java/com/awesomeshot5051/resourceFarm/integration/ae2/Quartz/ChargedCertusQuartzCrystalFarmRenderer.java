...
public class ChargedCertusQuartzCrystalFarmRenderer extends RendererBase<ChargedCertusQuartzCrystalFarmTileentity> {
    ...
    @Override
    public void render(ChargedCertusQuartzCrystalFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
