...
public class FlawedBuddingQuartzFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public FlawedBuddingQuartzFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.FBQ_FARM.get(), ModBlocks.FBQ_FARM.get().defaultBlockState(), pos, state);
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(AE2Blocks.CERTUS_QUARTZ_CRYSTAL.get(), dropCount));
        if (getPickaxeEnchantmentStatus(pickaxeEnchantments, Enchantments.SILK_TOUCH)) {
            drops.clear();
            drops.add(new ItemStack(AE2Blocks.FLAWED_BUDDING_QUARTZ.get()));
        }
