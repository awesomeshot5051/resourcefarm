...
public class FlawlessBuddingQuartzFarmRenderer extends RendererBase<FlawlessBuddingQuartzFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public FlawlessBuddingQuartzFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(FlawlessBuddingQuartzFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= FlawlessBuddingQuartzFarmTileentity.getCGlassGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= FlawlessBuddingQuartzFarmTileentity.getCGlassBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
