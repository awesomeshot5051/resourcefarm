...
public class FlawlessBuddingQuartzFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public FlawlessBuddingQuartzFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.FLBQ_FARM.get(), ModBlocks.FLBQ_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(FlawlessBuddingQuartzFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(FlawlessBuddingQuartzFarmTileentity tileEntity) {
