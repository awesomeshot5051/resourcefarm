...
public class QuartzClusterFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public QuartzClusterFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.QC_FARM.get(), ModBlocks.QC_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(QuartzClusterFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(QuartzClusterFarmTileentity tileEntity) {
