...
public class QuartzGlassFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public QuartzGlassFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.QG_FARM.get(), ModBlocks.QG_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(QuartzGlassFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(QuartzGlassFarmTileentity tileEntity) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(AE2Blocks.QUARTZ_GLASS.get(), dropCount));
        return drops;
    }
