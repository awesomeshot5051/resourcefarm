...
public class SiliconFarmRenderer extends RendererBase<SiliconFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public SiliconFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(SiliconFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= SiliconFarmTileentity.getCGlassGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= SiliconFarmTileentity.getCGlassBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
