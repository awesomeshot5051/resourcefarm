...
public class EntroBlockFarmRenderer extends RendererBase<EntroBlockFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public EntroBlockFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(EntroBlockFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= EntroBlockFarmTileentity.getCGlassGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= EntroBlockFarmTileentity.getCGlassBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
