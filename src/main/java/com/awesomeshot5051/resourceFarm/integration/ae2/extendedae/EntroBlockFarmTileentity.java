...
public class EntroBlockFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public EntroBlockFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.ENTB_FARM.get(), ModBlocks.ENTB_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(EntroBlockFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(EntroBlockFarmTileentity tileEntity) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(AE2Blocks.ENTRO_BLOCK.get(), dropCount));
        return drops;
    }
