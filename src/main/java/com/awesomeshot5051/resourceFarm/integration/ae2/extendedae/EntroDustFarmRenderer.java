...
public class EntroDustFarmRenderer extends RendererBase<EntroDustFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public EntroDustFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(EntroDustFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= EntroDustFarmTileentity.getCGlassGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= EntroDustFarmTileentity.getCGlassBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
