...
public class EntroDustFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public EntroDustFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.ENTD_FARM.get(), ModBlocks.ENTD_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(EntroDustFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(EntroDustFarmTileentity tileEntity) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(AE2Blocks.ENTRO_DUST.get(), dropCount));
        return drops;
    }
