...
public class SiliconBlockFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public SiliconBlockFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.SIB_FARM.get(), ModBlocks.SIB_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(SiliconBlockFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(SiliconBlockFarmTileentity tileEntity) {
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(AE2Blocks.SILICON_BLOCK.get(), dropCount));
        return drops;
    }
