...
public class CrystalChorusFarmBlock extends BlockBase implements EntityBlock, IItemBlock {

    public CrystalChorusFarmBlock() {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new CrystalChorusFarmItemRenderer();
            }
        };
    }
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof CrystalChorusFarmTileentity farmTileEntity) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        CrystalChorusFarmTileentity trader = BlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new CrystalChorusFarmTileentity(BlockPos.ZERO, ModBlocks.CCHORUS_FARM.get().defaultBlockState()));
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof CrystalChorusFarmTileentity farm)) {
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new CrystalChorusFarmTileentity(blockPos, blockState);
    }
