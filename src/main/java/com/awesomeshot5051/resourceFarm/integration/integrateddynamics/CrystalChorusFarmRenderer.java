...
public class CrystalChorusFarmRenderer extends RendererBase<CrystalChorusFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public CrystalChorusFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(CrystalChorusFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= CrystalChorusFarmTileentity.getCChorusGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= CrystalChorusFarmTileentity.getCChorusBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
