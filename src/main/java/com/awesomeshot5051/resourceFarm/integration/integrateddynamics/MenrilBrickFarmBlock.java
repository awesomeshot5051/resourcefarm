...
public class MenrilBrickFarmBlock extends BlockBase implements EntityBlock, IItemBlock {

    public MenrilBrickFarmBlock() {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new MenrilBrickFarmItemRenderer();
            }
        };
    }
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof MenrilBrickFarmTileentity farmTileEntity) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        MenrilBrickFarmTileentity trader = BlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new MenrilBrickFarmTileentity(BlockPos.ZERO, ModBlocks.CCHORUS_FARM.get().defaultBlockState()));
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof MenrilBrickFarmTileentity farm)) {
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new MenrilBrickFarmTileentity(blockPos, blockState);
    }
