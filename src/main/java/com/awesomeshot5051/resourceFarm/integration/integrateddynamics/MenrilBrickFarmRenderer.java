...
public class MenrilBrickFarmRenderer extends RendererBase<MenrilBrickFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public MenrilBrickFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(MenrilBrickFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= MenrilBrickFarmTileentity.getMBrickGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= MenrilBrickFarmTileentity.getMBrickBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
