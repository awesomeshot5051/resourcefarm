...
public class CrystalChorusGlassFarmRenderer extends RendererBase<CrystalChorusGlassFarmTileentity> {
    private final BlockRenderDispatcher blockRenderDispatcher;

    public CrystalChorusGlassFarmRenderer(BlockEntityRendererProvider.Context renderer) {
        super(renderer);
        this.blockRenderDispatcher = renderer.getBlockRenderDispatcher();
    }

    @Override
    public void render(CrystalChorusGlassFarmTileentity farm, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        ...
        if (farm.getTimer() >= CrystalChorusGlassFarmTileentity.getCGlassGenerateTime(farm)) {
        ...
        } else if (farm.getTimer() >= CrystalChorusGlassFarmTileentity.getCGlassBreakTime(farm)) {
            blockRenderDispatcher.renderSingleBlock(
                    Blocks.AIR.defaultBlockState(),
                    matrixStack,
                    buffer,
