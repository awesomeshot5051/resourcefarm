...
public class CrystalChorusGlassFarmTileentity extends FarmTileentity implements ITickableBlockEntity {
    ...
    public CrystalChorusGlassFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.CCGLASS_FARM.get(), ModBlocks.CCGLASS_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getCGlassGenerateTime(CrystalChorusGlassFarmTileentity tileEntity) {
    ...
    public static double getCGlassBreakTime(CrystalChorusGlassFarmTileentity tileEntity) {
